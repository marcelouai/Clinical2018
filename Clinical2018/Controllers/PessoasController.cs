...
namespace Clinical2018.Models
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(Clinical2018Context context)
        {
            _context = context;
        }
